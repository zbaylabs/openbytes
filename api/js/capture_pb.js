...
proto.openbytes.CopyRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.openbytes.Address.toObject, includeInstance)
  };
...
/**
 * repeated Address destinations = 2;
 * @return {!Array<!proto.openbytes.Address>}
 */
proto.openbytes.CopyRequest.prototype.getDestinationsList = function() {
  return /** @type{!Array<!proto.openbytes.Address>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.openbytes.Address, 2));
};


/**
 * @param {!Array<!proto.openbytes.Address>} value
 * @return {!proto.openbytes.CopyRequest} returns this
*/
...
/**
 * @param {!proto.openbytes.Address=} opt_value
 * @param {number=} opt_index
 * @return {!proto.openbytes.Address}
 */
proto.openbytes.CopyRequest.prototype.addDestinations = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.openbytes.Address, opt_index);
};
